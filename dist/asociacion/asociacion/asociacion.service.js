...
exports.AsociacionService = void 0;
const common_1 = require("@nestjs/common");
const asociacion_entity_1 = require("./entities/asociacion.entity");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
let AsociacionService = class AsociacionService {
    constructor(asociacionRepo) {
...
exports.AsociacionService = AsociacionService;
exports.AsociacionService = AsociacionService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(asociacion_entity_1.Asociacion)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], AsociacionService);
//# sourceMappingURL=asociacion.service.js.map