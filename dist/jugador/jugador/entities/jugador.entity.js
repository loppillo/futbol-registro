...
__decorate([
    (0, typeorm_1.ManyToOne)(() => club_entity_1.Club, (club) => club.jugadores, { eager: true, onDelete: 'SET NULL' }),
    (0, typeorm_1.JoinColumn)({ name: 'clubId' }),
    __metadata("design:type", club_entity_1.Club)
], Jugador.prototype, "club", void 0);
__decorate([
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", Number)
], Jugador.prototype, "clubId", void 0);
